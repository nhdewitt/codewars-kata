...
def black_or_white_key(key_press_count):
    keys = ["white", "black", "white", "white", "black", "white", "black", "white", "white", "black", "white", "black"] # A -> G#
    key_press_count = (key_press_count - 1) % 88 % 12                                                                   # normalize to 88-key piano, find 0-based index and return
    return keys[key_press_count]